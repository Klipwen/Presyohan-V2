...
class ManageCategoryActivity : AppCompatActivity() {
    ...
    private fun cloneCategory(category: String) {
        ...
        ClonePricesDialogHelper.show(
            ...
            descriptionText = "Enter the 6-digit paste-code generated by the destination store to securely clone all $count prices in \"$category\"."
        )
    }
    ...
    private fun showConvertPricelistDialog(items: List<ManageItemData>) {
        ...
        btnCopyPreview.setOnClickListener {
            if (generatedNoteText.isNotBlank()) {
                ...
                clipboard.setPrimaryClip(android.content.ClipData.newPlainText("Pricelist Note", generatedNoteText))

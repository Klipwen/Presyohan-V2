package com.presyohan.presyohanapp
                                ...
                                db.collection("users").document(ownerUid)
                                    ...
                                    .addOnSuccessListener { notifSnapshot ->
                                        ...
                                        val notif = hashMapOf(
                                            ...
                                            "message" to "${currentUser.displayName ?: currentUser.email ?: "User"} requested to join your store.",
                                            "unread" to true
                                        )
                                        db.collection("users").document(ownerUid)
                                            .collection("notifications")
                                            ...
                                            .addOnSuccessListener {
                                                ...
                                                db.collection("users").document(currentUser.uid)
                                                    ...
                                                    .addOnSuccessListener {
                                                        ...
                                                        val intent = android.content.Intent(this, com.project.presyohan.StoreActivity::class.java)

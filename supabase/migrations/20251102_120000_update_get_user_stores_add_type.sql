-- Migration: Update get_user_stores RPC to include store type
...
RETURNS TABLE(store_id UUID, name TEXT, branch TEXT, type TEXT, role TEXT)
LANGUAGE plpgsql
SECURITY DEFINER SET search_path = public
  ...
  IS 'Returns all stores for the current user with branch, type, and role; schema-aware user mapping.';
